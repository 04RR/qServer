...
A bulletproof local inference stack for four Qwen models on a single dual-GPU workstation
...
|---|---|---|---|
| 27B dense Q4 | `qwen-27b` (`qwen36`) | 4090 | 101–118 t/s |
| 27B dense Q6 | `qwen-27b-q6` (`qwen36-q6`) | 4090 + 5060 Ti | ~64 t/s |
| 35B-A3B MoE | `qwen-35b` (`qwen36-35b`) | 4090 + 5060 Ti | ~206 t/s |
| 122B-A10B MoE | `qwen-122b` (`qwen35-122b`) | 4090 + 5060 Ti + RAM | ~37–40 t/s |

All: 131072 context, q8_0 KV, MTP speculative decoding, thinking on.
